...
public class PrisonersDilemmaTest {
    ...
    public void testCooperateVsDefect() {
        ...
        // Cooperator always gets 0, Defector always gets 5
        // 5 rounds: Cooperator = 0, Defector = 25
    ...
    public void testTitForTatVsDefector() {
        ...
        // Round 1: TFT cooperates, Defector defects -> TFT: 0, Defector: 5
        // Rounds 2-5: Both defect -> TFT: 4*1=4, Defector: 4*1=4
        // Total: TFT: 4, Defector: 9
