...
public abstract class Game {
    ...
    public int[] run(Robot robot1, Robot robot2) {
        ...
        // Preparation for TitForTat bots if needed
        if (robot1 instanceof robot.TitForTatBot) {
            ((robot.TitForTatBot) robot1).setCurrentOpponent(robot2.getName());
        }
        if (robot2 instanceof robot.TitForTatBot) {
            ((robot.TitForTatBot) robot2).setCurrentOpponent(robot1.getName());
        }
